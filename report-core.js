...
function renderChart(rows) {
  ...
  els.chartPanel.replaceChildren(...data.map(([label, value]) => {
    ...
    fill.style.width = `${Math.max(0, (Number(value) / max) * 100)}%`;
    track.append(fill);
